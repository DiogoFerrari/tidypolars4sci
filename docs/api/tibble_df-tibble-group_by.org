...
#+RESULTS[53f9c8600c66662c73db6c3ee3660f276af02448]:
#+begin_src python
shape: (3, 2)
┌──────────────┐
│ cyl   avg_am │
...
# 
#+BEGIN_SRC python :exports both :results output code :tangle src-tibble_df-tibble-group_by.py :cache yes :noweb no :session *Python* :linenums 1 :eval always
...
#+RESULTS[e7fdb188138c6d13fbe3e1a5fa3823466ef0c6c0]:
#+begin_src python
shape: (5, 13)
┌───────────────────────────────────────────────────────────────────────────────────────────────────────┐
