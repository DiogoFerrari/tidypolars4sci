...
# 
#+BEGIN_SRC python :exports both :results silent :tangle src-nest.py :cache yes :noweb no :session *Python* :linenums 1 :eval always
...
# 
#+BEGIN_SRC python :exports both :results output code :tangle src-nest.py :cache yes :noweb no :session *Python* :linenums 1 :eval always
dfnested.print()
#+END_SRC

#+RESULTS[9815aa7d3304c720e195b1991f419fb6b142e2ab]:
#+begin_src python
shape: (3, 2)
┌──────────────────────────────────────────────────────────────────────────────────────────────────────┐
│ cyl   data                                                                                           │
...
To extract information from the model, let us say the AIC, and store it in the table:
# 
#+BEGIN_SRC python :exports both :results output code :tangle src-nest.py :cache yes :noweb no :session *Python* :linenums 1 :eval always
print(
    mod
...
#+RESULTS[c6ccfd8f4f632033e6da73ee882c8bb96698dd0c]:
#+begin_src python
shape: (2, 5)
┌────────────────────────────────────────┐
...
#+RESULTS[5b01bb13eed55c73f33aa614a4d4731bc03a46f0]:
#+begin_src python
